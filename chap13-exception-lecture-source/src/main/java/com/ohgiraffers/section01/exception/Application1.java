...
public class Application1 {
    public static void main(String[] args) throws Exception {
         ...
         * 코드를 컴파일 하려고 할 떄 컴파일 에러를 발생시킨다.
         * => 문법상의 오류
         * 컴퓨터 프로그램이 동작하는 도중에 예상치 못한 사태가 발생하여
         * 실행중인 프로그램이 영향을 받는 것을 오류(Error) 와 에외(Exception)
         * 이 두가지로 구분할 수 있다.
         *
         *
         * 오류(Error)
         * 시스템 상에서 프로그램에 심각한 문제를 발생하여 실행중인 프로그램이 종료되는것.
         * 이러한 오류는 개발자가 미리 예측하여 처리하는 것이 불가능 하며, 오류에 대한 처리는 할 수 없다.
         *
         *
         * 예외(Exception)
         * 오류와 마찬가지로 실행중인 프로그램을 비정상적을 종료시키지만,
