...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        sum = sum + 10;
        System.out.println(" sum에 10 을 더하면 현재 sum의 값은 ? " + sum); // 10

        sum = sum + 10;
        System.out.println(" sum에 10 을 더하면 현재 sum의 값은 ? " + sum); // 20

        sum = sum + 10;
        System.out.println(" sum에 10 을 더하면 현재 sum의 값은 ? " + sum); // 30
