...
public class Appcation01 {
    public static void main(String[] args) {
        ...
        * API
        *
        * Application Programming Interface 는 플그램에서 사용할 수 있도록
        * 운영체게나 프로그래밍 언어가 제공하는 기능을 제어할 수 있도록 만든 인터페이스를 뜻함
        * 쉽게 말해 우리가 구현 할 수 없거나 구현하기 번거로운 기능들을 JDK를 설치하면 자동으로
        * 사용할 수 있도록 제공해 놓은 소스코드(클래스나 인터페이스)를 의미함
        * => 누군가 작성해놓은 소스코드이니 가져다 쓰는 방법을 본다는 말
        *
        * java.lang.Math
        *
        * Math 클래스는 수학에서 자주 사용하는 상수들과 함수 들을 미리 구현해놓은 클래스이다.
        * 모든 메소드는 static 메소드로 작성한다.
        * */

        System.out.println(" -7의 절대값 : " + (java.lang.Math.abs(-7)));

        // java.Lang 패키지는 자주사용하기 때문에 컴파일러가 import java.Lang.*;를 자동으로 추가해준다.
