...
public class Appcation02 {
    public static void main(String[] args) {
        ...
        * 참조 자료형 이라고한다.*/
        ...
        //배열의 할당을 할시에는 반드시 배열의 크기를 지정해야한다.
        //iarr = new int[]; : 크기를 지정해주지 않아서 에러가 발생

        iarr = new int[5];
        carr = new char[5]; // 타입도 맞춰야한다.
        ...
        * -> 동익객체인지 비교할 떄 사용할 목적으로 많이 쓰이며,동등객체를 동일객체 위급하기 위한 용도로
        * Overing 해서 사용한다.*/
        ...
        System.out.println("larr의 길이 + " + larr.length);
        ...
        // 배열의 사이즈를 변경한 것이 아니고,
        // 새로운 배열을 생성해서 그 주소값을 페러런스 변수에 덮어 쓴 것이다.
        System.out.println("darr의 hashcode :" + darr.hashCode());
        System.out.println("darr의 길이 :" + darr.length);
