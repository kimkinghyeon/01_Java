...
public class Application01 {
    public static void main(String[] args) {
         ...
         * 다차원 배열
         *
         * 다차월 배열은 2차월 이상의 배열을 의미한다.
         * 배열의 인덱스마다 또 다른 배열의 주소를 보관하는 배열을 의미한다.
         * -> 2차월 배열은 1차원 배열 여러개를 하나로 묶어서 관리하는 배열을 의미한다.
         *
         * 2차월 배열을 사용하는 방법
         * 1. 배열의 주소를 보관하는 레퍼런스 변수 선언(stack)
         * 2. 여러개의 1차월 배열의 주소를 관리하는 배열을 생성(heap)
         * 3. 각 인덱스에서 관리하는 배열을 할당하여 주소를 보관하는 배열에 저장
         * 4. 생성한 여러개의 1차월 배열에 차례로 접근해서 사용
         * */
        // int[] arr[]; X
        int[][] arr;
        int arr2[][];
        ...
        //arr2 = new int[][2];
        arr = new int[3][]; // 주소를 묶어서 관리할 배여읠 크기를 지정해야함
        ...
        // heap 영역에는 값이 없는 상태로 공간 생성이 불가능하기 때문에
        // ,기본값이 돌어있다.
