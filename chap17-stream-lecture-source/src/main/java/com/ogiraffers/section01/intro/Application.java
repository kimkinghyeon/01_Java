package com.ogiraffers.section01.intro;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * 4. 스트림은 작업을 병렬 처리할 수 있다. (멀티 쓰레드)*/

        List<String> stringList = new ArrayList<String>(Arrays.asList("hello","world","stream","hello"));
        ...
        System.out.println("========== stream 사용 이후==========");
        /* distinct() : 중복 제거
        * limit() : 매개변수로 넣은 정수만큼 잘라준다. / 반복 제한 예) limit(3) 'ㅁ','2','5','5','ㅁ'
        *                                                          출력값 = ㅁ 2 5
        * sorted() : 오름차순으로 정렬
        * sorted(Comparator.reverseOrder() : 내림차순 */
        stringList.stream() // 스트림화
                .distinct() // 중간연산
