...
public class Appcation01 {
    public static void main(String[] args) {
        ...
        *   1-1. &&(논리 AND) 연산자 :
        *       -두 개의 논리식이 모두 참 일경우 True(참)을 반환
        *       -둘 중 한개라도 거짓인 경우 false(거짓)를 반환하는 연산
        *   1-2. ||(논리 OR) 연산자 :
        *       -두 개의 논리식 중 둘 중 하나라도 True(참)일 경우 True
        *       -둘 다 모두 거짓일 경우 false(거짓)를 반환하는 연산
        * 2. 논리 부정 연산자
        *   피연산자가 하나인 단항연사자로, 피연산자의 결합 방향은 왼쪽에서 오른쪽이다.
        ...
        * */
        ...
        System.out.println("a가 b보다 작으면서 c가 d 보다 작은지 확인 : " +(a < b && c < d));
        System.out.println("a가 b보다 작으면서 c가 d 보다 큰지 확인 : " +(a < b && c > d));
        System.out.println("a가 b보다 크면서 c가 d 보다 작은지 확인 : " +(a > b && c < d));
        System.out.println("a가 b보다 크면서 c가 d 보다 큰지 확인 : " +(a > b && c > d));
        //-두 개의 논리식이 모두 참 일경우 True(참)을 반환
        //-둘 중 한개라도 거짓인 경우 false(거짓)를 반환하는 연산
        ...
        //-두 개의 논리식 중 둘 중 하나라도 True(참)일 경우 True로 반환
        //-둘 다 모두 거짓일 경우 false(거짓)를 반환하는 연산
