...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Animal Rabbit 생성------------------");
        ...
        System.out.println("Animal Tiger 생성------------------");
        ...
        Animal a2 = new Tiger();
        System.out.println("Animal Chimera 생성------------------");
        ...
        // 현재 레퍼런스 변수의 타입이 Animal 이기 때문에
        // Rabbit 과 Tiger 가 가지고 있는 고유 기능은 동작시키지 못한다.
...
//        a2.bite();
        ...
        System.out.println("a1이 Tiger 인지 확인 : " + (a1 instanceof Tiger));
        System.out.println("a1이 Rabbit 인지 확인 : " + (a1 instanceof Rabbit));
        // 상속받은 타입도 함께 가지고있다. (다형성)
        System.out.println("a1이 Animal 인지 확인 : " + (a1 instanceof Animal));
        System.out.println("a1이 Object 인지 확인 : " + (a1 instanceof Object));
        ...
        * 작성 여부에 따라 명시적과 묵시적으로 구분*/
        ...
        /*
         * 동적 바인딩
         * 컴파일 당시에는 해당 타입의 메소등와 연결이 되어있다가
         * 런타입 당시 실제 객체가 가진 오버라이딩된 메소드로 바인딩이 바뀌어 동작하는것*/
