...
public class Application03 {
    public static void main(String[] args) {
        // Function : 매개변수와 리턴값이 있는 applyxxx()메소드를 가지고있다.

        /* Function<T, R>#apply(T t) : R : 객체 T 를 R로 매핑한다. */
        ...
        // BiFunction<T,U,R>#apply(T t, U u) : R : 객체 T와 U를 R로 매핑
        ...
        // IntFunction<R>#apply(int value) : R : int 를 R 로 매핑한다.
